...
exports.createTeacher = async (req, res) => {
  try {
    ...
    try {
      ...
      await sendMail({
        email: teacher.email,
        subject: "Welcome to Smart Education - Teacher Account Created",
      ...
      res.status(201).json({
        status: "success",
        message: "Teacher created successfully, but welcome email could not be sent.",
        data: {
          teacher: {
            _id: teacher._id,
            fullName: teacher.fullName,
...
exports.updateUserRole = async (req, res) => {
  try {
    ...
    // Validate role (optional if not always provided)
